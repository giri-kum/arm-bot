...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sldrMaxTorque.setProperty("value", 30)
        ...
        self.PixelCoordLabel.setGeometry(QtCore.QRect(310, 518, 181, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.PixelCoordLabel_2.setGeometry(QtCore.QRect(640, 518, 181, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rdoutMousePixels.setGeometry(QtCore.QRect(490, 518, 131, 17))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Ubuntu Mono"))
        ...
        self.rdoutMouseWorld.setGeometry(QtCore.QRect(830, 518, 141, 17))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Ubuntu Mono"))
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.groupBox.setGeometry(QtCore.QRect(2, 770, 971, 26))
        ...
        self.radioVideo.setGeometry(QtCore.QRect(310, 8, 117, 22))
        ...
        self.radioGroup.addButton(self.radioVideo)
        self.radioDepth = QtGui.QRadioButton(self.centralwidget)
        self.radioDepth.setGeometry(QtCore.QRect(430, 8, 117, 22))
        self.radioDepth.setObjectName(_fromUtf8("radioDepth"))
        self.radioGroup.addButton(self.radioDepth)
        self.radioUsr1 = QtGui.QRadioButton(self.centralwidget)
        self.radioUsr1.setGeometry(QtCore.QRect(550, 8, 117, 22))
        self.radioUsr1.setObjectName(_fromUtf8("radioUsr1"))
        self.radioGroup.addButton(self.radioUsr1)
        self.radioUsr2 = QtGui.QRadioButton(self.centralwidget)
        self.radioUsr2.setGeometry(QtCore.QRect(680, 8, 117, 22))
        self.radioUsr2.setObjectName(_fromUtf8("radioUsr2"))
        self.radioGroup.addButton(self.radioUsr2)
        ...
        self.radioVideo.raise_()
        self.radioDepth.raise_()
        self.radioUsr1.raise_()
        self.radioUsr2.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.PixelCoordLabel.setText(_translate("MainWindow", "Raw Mouse Coordinates:", None))
